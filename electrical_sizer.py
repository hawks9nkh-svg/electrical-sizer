...
st.info("Tabs for Normal/Emergency. Fire Alarm and Fire Pump added to Emergency. Always verify with full NEC.")

if st.button("Show Breakdown"):
    st.dataframe(pd.DataFrame({
        "Component": ["Normal General", "Kitchen", "HVAC", "Life Safety", "Fire Alarm", "Fire Pump", "Elevators", "Standby", "Grand Total"],
        "kVA": [demand_general_kva, kitchen_demand_kva, hvac_demand_kva, life_safety_kva, fire_alarm_kva, fire_pump_kva, elevator_kva, standby_kva, grand_total_kva]
    }))
